        ...
        <div className="flex w-full flex-col items-center">
          <div className="flex items-start justify-between gap-5 self-stretch md:flex-col">
            <div className="flex w-[32%] flex-col gap-[37px] md:w-full">
              <Img src="images/img_footer_logo.png" alt="footerlogo" className="h-[50px] w-[223px] object-contain" />
              <div className="flex flex-col gap-[19px]">
                ...
                <div className="flex items-center gap-2.5">
                  <Img src="images/img_lock_black_900_02.svg" alt="lock" className="h-[24px] w-[24px] self-start" />
